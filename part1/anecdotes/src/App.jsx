...
const App = () => {
  ...
  const handleVote = () => {
    ...
    // Update the index of the anecdote with the most votes
    const maxVotes = Math.max(...newVotes)
    const idxOfMaxVotes = newVotes.indexOf(maxVotes)
    setIdxOfMaxVotes(idxOfMaxVotes)
  }
